...
const ChatPage = () => {
  ...
  return (
    <div className="flex flex-col w-full h-screen pb-10 bg-gray-200">
      <div className="w-full flex items-center px-4 py-6 justify-center ">
        <header>
          <h1 className="text-[3rem] font-extrabold text-black">ASK BOT</h1>
        </header>
      </div>
